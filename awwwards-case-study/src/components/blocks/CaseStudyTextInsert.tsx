...
export function CaseStudyTextInsert({ title, children, type = "editorial", className }: TextInsertProps) {
            ...
            <div className="grid md:grid-cols-12 gap-8 md:gap-12">
                {title && (
                    <div className="md:col-span-4 lg:col-span-3">
                        <h3 className="text-lg md:text-xl font-bold uppercase tracking-wide border-t border-black/10 pt-4 text-brand">
                            {title}
                        </h3>
                    </div>
                )}
